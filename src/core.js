...
import { AxisInternal } from "./axis-internal.js";
...
ChartInternal.prototype.initParams = function () {
  ...
  $$.xOrient = config.axis_rotated
    ? config.axis_x_inner ? "right" : "left"
    : config.axis_x_inner
    ? "top"
    : "bottom";
  $$.yOrient = config.axis_rotated
    ? config.axis_y_inner ? "top" : "bottom"
    : config.axis_y_inner
    ? "right"
    : "left";
  $$.y2Orient = config.axis_rotated
    ? config.axis_y2_inner ? "bottom" : "top"
  ...
  $$.rotated_padding_right = config.axis_rotated && !config.axis_x_show
    ? 0
    : 30;
...
ChartInternal.prototype.updateSizes = function () {
  ...
  var legendHeight = $$.legend ? $$.getLegendHeight() : 0,
    ...
    legendHeightForBottom = $$.isLegendRight || $$.isLegendInset
      ? 0
      : legendHeight,
    hasArc = $$.hasArcType(),
    xAxisHeight = config.axis_rotated || hasArc ? 0
    : $$.getHorizontalAxisHeight("x"),
    subchartXAxisHeight = config.axis_rotated || hasArc ? 0
