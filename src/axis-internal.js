...
AxisInternal.prototype.updateTickLength = function () {
  var internal = this;
  internal.tickLength = Math.max(internal.innerTickSize, 0) +
    internal.tickPadding;
};
AxisInternal.prototype.lineY2 = function (d) {
  var internal = this,
    tickPosition = internal.scale(d) +
...
AxisInternal.prototype.generateAxis = function () {
    ...
    g.each(function () {
      ...
      switch (internal.orient) {
        ...
        case "right": {
          ...
          tspanUpdate.attr("x", internal.tickLength).attr(
            "dy",
            function (d, i) {
              return internal.tspanDy(d, i);
            },
  ...
  axis.orient = function (x) {
    ...
    internal.orient = x in { top: 1, right: 1, bottom: 1, left: 1 }
      ? x + ""
      : "bottom";
    return axis;
  };
